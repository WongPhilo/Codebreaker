...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Codebreaker", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Codebreaker", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Codebreaker";
		app.meta["name"] = "Codebreaker";
